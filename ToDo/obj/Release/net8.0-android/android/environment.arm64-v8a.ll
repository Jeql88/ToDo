...
@dso_cache = dso_local local_unnamed_addr global [492 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 6980880306517153724, ; hash 0x60e111a7097997bc, from name: aot-ToDo
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ToDo.dll.so
		ptr null; void* handle (0x0)
	}, ; 158
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 9317457789724945366, ; hash 0x814e427e66406bd6, from name: libaot-ToDo
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ToDo.dll.so
		ptr null; void* handle (0x0)
	}, ; 242
	...
	%struct.DSOCacheEntry {
		i64 11663753595342669522, ; hash 0xa1ddfa190615c6d2, from name: aot-ToDo.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ToDo.dll.so
		ptr null; void* handle (0x0)
	}, ; 306
	...
	%struct.DSOCacheEntry {
		i64 12920721686079849027, ; hash 0xb34f9feaa479c243, from name: ToDo
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ToDo.dll.so
		ptr null; void* handle (0x0)
	}, ; 340
	...
	%struct.DSOCacheEntry {
		i64 13907014848862952652, ; hash 0xc0ffa452908f1ccc, from name: libaot-ToDo.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ToDo.dll.so
		ptr null; void* handle (0x0)
	}, ; 371
	...
	%struct.DSOCacheEntry {
		i64 14466820116110249827, ; hash 0xc8c4783f423a0f63, from name: ToDo.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ToDo.dll.so
		ptr null; void* handle (0x0)
	}, ; 392
...
@.env.3 = private unnamed_addr constant [37 x i8] c"fadb15a2-9d0e-4860-a23d-9fa3550e3a5d\00", align 1
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [19 x i8] c"libaot-ToDo.dll.so\00", align 1
